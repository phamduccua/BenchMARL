...
if _has_hydra:
    ...
    def _load_hydra_schemas():
        ...
        # Load optimizer schemas
        for optim_name, optim_schema in optimizer_config_registry.items():
            cs.store(name=f"{optim_name}_config", group="optimizer", node=optim_schema)
